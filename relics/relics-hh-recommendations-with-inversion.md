# HH Champion Relic Recommendation Inversion

## Scope

This dataset contains only champion-specific relic recommendations observed from HellHades champion relic recommendation screens reviewed in this chat.

Rules:
- One row per unique relic.
- Champion list contains only champions directly observed in HH recommendation screens.
- No interpretation or roster matching.
- Generic HH relic-page examples are excluded.
- Champions with no recommendations are tracked separately.

---

## Relic → Recommended Champions
...
## Champion Screens Processed

| Champion | Recommended Relics |
|---|---|
| Alice the Wanderer | Gorecrescent, Malefic Talon, The Cat's Gaze |
| Arbiter | Wand of Submission, Hallowed Hilt, Journal of Necrotos |
| Artak | Golden Elixir, Orb of Transfixion, Skull of Treason |
| Astralon | Irethi Coronet, Malefic Talon, The Cat's Gaze |
| Bad-el-Kazar | Journal of Necrotos, Perched Shadow, Arachnelixir |
| Armiger | No recommendations displayed |
| Basher | Wand of Submission, Orb of Transfixion |
| Chronicler Adelyn | Perched Shadow |
| Coldheart | Irethi Coronet, Malefic Talon, Perched Shadow |
| Criodan the Blue | Journal of Necrotos, Perched Shadow |
| Deacon Armstrong | Wand of Submission, Journal of Necrotos, Perched Shadow |
| Demytha | Journal of Necrotos, Perched Shadow |
| Duchess Lilitu | Wand of Submission, Volcardiac Heart, Demonic Effigy |
| Elva Autumnborn | Journal of Necrotos, Chrysalid of Rebirth, Perched Shadow |
...
## Relic Recommendation Frequency
...
## Champions With No HH Relic Recommendations
