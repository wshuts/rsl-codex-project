# Relic Master Reference

## Purpose

Canonical reference artifact for relic management, evaluation, reserve-vault planning, and food workflows.

---

# Champion Relic Assignments

| Row | Champion | Relic |
|------|------|------|
| 1 | Embrys the Anomaly | Wand of Submission |
| 2 | Sun Wukong | Malefic Talon |
| 3 | Goffred Brassclad | Aspect of Siroth |
| 4 | Sulfuryion | Darksmile's Toast |
...
| 12 | Vestele Riverthorn | Gorecrescent |
| 13 | Leminisi the Gold-Wing | Golden Elixir |
| 14 | Coldheart | Golden Elixir |
| 15 | Yakarl the Scourge | Golden Elixir |
| 16 | Whisper | Golden Elixir |
| 17 | Melga Steelgirdle | Demonic Effigy |
| 18 | Rector Drath | Demonic Effigy |
| 19 | Madame Serris | Molten Deathbell |
| 20 | Criodan the Blue | Molten Deathbell |

---

# Equipped Relic Counts
...
# Relics Appearing More Than Once
...
## Virtual Reserve Vault

- Champions act as relic mules.
- Equipped reserve relics are considered preserved assets.
- Unequipped relic storage is intended to function as a food locker.
- New keeper relics should be moved onto champions to avoid polluting the food workflow.

## Gemstone Scope

Relic discussions use a simplified gemstone state:

- Full
- Partial
- Empty

Gemstone quality, tier, color, shape, and inventory management are out of scope for this document.
